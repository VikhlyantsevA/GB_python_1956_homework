...
class Worker:
    ...
    def __init__(self, name: str, surname: str, position: str, income: dict):
        ...
        self.check_dict_keys(self.__income, ['wage', 'bonus'])

    def check_dict_keys(self, dictionary: dict, keys_must_be: list):
        if not all(key in dictionary for key in keys_must_be):
            raise KeyError(f"Some of {keys_must_be} fields weren't provided")
